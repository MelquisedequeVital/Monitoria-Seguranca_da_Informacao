...
*   **Exemplo:** Hackers invadem os servidores de uma clínica médica e vazam na internet os prontuários e resultados de exames de milhares de pacientes.
...
*   **Exemplos:**
    *   O uso de protocolo HTTPS que comprova que você está acessando o site real do seu banco e não uma cópia falsa.
...
*   **Exemplos:**
    *   Uso de certificado digital padrão ICP-Brasil para assinar um contrato; o autor não pode alegar que não assinou.
...
*   **Consequências:** Impossibilidade de cobrar devedores judicialmente e brechas para fraudes internas sem culpados identificáveis.
*   **Exemplo:** Um cliente contrata um empréstimo e depois alega na Justiça que nunca assinou aquele documento. Sem métodos de autenticação forte, a empresa não consegue provar a autoria.
...
*   **Exemplos:**
    *   Adequar os sistemas internos para atender às regras da LGPD (Lei Geral de Proteção de Dados).
...
*   **Consequências:** Sanções administrativas, suspensão de atividades e multas pesadas.
*   **Exemplo:** Uma empresa coleta dados pessoais sensíveis de menores sem consentimento. A ANPD descobre a prática e aplica uma multa baseada no faturamento da empresa.
